...
#ifndef				__LAPIN_COMPAT_INI_H__
# define			__LAPIN_COMPAT_INI_H__
...
** The compat INI file contains functions that were used by
** previous version of the LibLapin to handle INI file.
**
...
**
** These symbols and functions are obsolete and should not be used anymore.
** Insteadk use the new bunny_configuration API that can be found inside
** configuration.h.
** These functions are still present for backward compatibility
*/
...
# define			bunny_ini_first(ini)				bunny_ini_first_scope(ini)
# define			bunny_ini_next(ini, scope)			bunny_ini_next_scope(ini, scope)
...
** Please use t_bunny_configuration instead.
*/
...
**
** This symbol is obsolete and should not be used anymore.
