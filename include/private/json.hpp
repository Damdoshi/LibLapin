...
#ifndef			__LAPIN_PRIVATE_JSON_HPP__
# define		__LAPIN_PRIVATE_JSON_HPP__
...
Decision		json_read_field(const char			*code,
					...
					SmallConf			&conf,
					SmallConf			&root);
Decision		json_read_inside_array(const char		*code,
					       ssize_t			&i,
					       SmallConf		&conf,
					       SmallConf		&root);
...
Decision		json_read_scope(const char			*code,
					...
					SmallConf			&conf,
					SmallConf			&root);
void			json_read_separator(const char			*code,
					    ssize_t			&i);
char			*_bunny_write_json(const t_bunny_configuration	*config);

#endif	/*		__LAPIN_PRIVATE_JSON_HPP__		*/
