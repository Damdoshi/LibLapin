...
<div class="resume">
  <h3>Description</h3>
  $A Open a sound file and load it. The sent file can be a configuration file.
  <br />
  <br />
  Delete the sound file with bunny_delete_sound when you do not
  need it anymore.<br />
  <br />
  Note that the t_bunny_effect field $Ssample_per_second@ can be different
  from SAMPLE_PER_SECONDS as it was not created by bunny_new_effect
  and is fully based on the loaded file.
</div>
<hr />
...
<div class="parameters">
  ...
  <ul>
    <li>
      ...
      $A The sound file to open. Supported files are .wav and .ogg.<br />
