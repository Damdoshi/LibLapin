<div class="prototype">
  Macro
  $Tt_bunny_server@ *$Sbunny_new_server@(
  $Tuint16_t@ $Sport@
  );
</div>
<hr />
...
<div class="resume">
  ...
  type $SBPT_TCP@ and listen on $Sport@.<br />
  <br />
...
<div class="details">
  ...
  <p>
    $Tt_bunny_server@ *$S_bunny_new_server_opt@(
    $Tuint16_t@ $Sport@,
    $Tt_bunny_protocol@ $Sprotocol@
    );
  </p>
  <p>It fill the second parameter with $SBPT_TCP@.</li>
</div>
