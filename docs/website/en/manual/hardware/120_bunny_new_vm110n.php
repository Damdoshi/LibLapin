<div class="prototype">
  $Tt_bunny_vm110n@ *$Sbunny_new_vm110n@($Tsize_t@ $Sid@);
</div>
<hr />
...
<div class="resume">
  ...
  returned data must be freed with bunny_delete_vm110n.
</div>
<hr />
...
<div class="return">
  ...
  <ul>
    <li>
      On $Bsuccess@, the function returns a valid t_bunny_vm110n.
    </li>
    <li>
