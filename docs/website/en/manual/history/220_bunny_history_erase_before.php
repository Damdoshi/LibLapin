<div class="prototype">
  $Tsize_t@ $Sbunny_history_erase_before@(
...
<div class="resume">
  <h3>Description</h3>
  $A This function erase every frames before the one used at the sent time index.
</div>
<hr />
...
<div class="parameters">
  ...
  <ul>
    ...
    <li>
      $Tsize_t@ $Stime@:<br />
      $A The time index of the status you want to turn as the oldest one.
