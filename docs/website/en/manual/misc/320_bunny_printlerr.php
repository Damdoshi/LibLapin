<div class="prototype">
  Macro
  $Tssize_t@ $Sbunny_printlerr@($Kconst@ $char@ *$Slitteral_string@);
</div>
<hr />

<div class="resume">
  <h3>Description</h3>
  $A Write a <b>litteral string</b> on stderr. Example:<br />
  bunny_printlerr($L"this is a litteral string"@);<br />
  <br />
  Bad example:
