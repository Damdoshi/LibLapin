<div class="prototype">
  $Ktypedef@ $Tvoid@ *(*$St_bunny_my_set_pixel@)(
...
<div class="resume">
  <h3>Description</h3>
  $A This type is the one used by gl_bunny_my_set_pixel function pointer
  that may be used to complete bunny_set_pixel by giving it the ability to
