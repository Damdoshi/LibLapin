...
<div class="resume">
  <h3>Description</h3>
  $A Set $Sdata@ inside the sent $Smap@ at $Skey@, which is of type $Stype@.
</div>
<hr />
...
<div class="parameters">
  ...
  <ul>
    ...
    <li>
      $Skey@:<br />
      $A The key of the element you want to set.
    </li>
    <li>
      $Sdata@:<br />
      $A The data you want to set.
    </li>
    <li>
      $Stype@:<br />
      $A The type of the data you want to set, any type is possible.
    </li>
  </ul>
</div>
<hr />
