...
<div class="resume">
  ...
  <?=urlforge(4, "manual", $mod, "bunny_free"); ?>.
</div>
<hr />
...
<div class="error_and_log">
  ...
  <ul>
    <li>
      ...
      <p>
        Out of memory.<br />
        If $CLAPIN_ALLOCATOR_DEACTIVATED@ was not set at library compile time,
        it means the prereserved memory space is exhausted. See
        <a href="<?=urlforge(4, "manual", $mod, "bunny_set_maximum_ram"); ?>">
...
<div class="related_functions">
  ...
  <ul>
    <li><?=urlforge(4, "manual", $mod, "bunny_set_maximum_ram"); ?></li>
    <li><?=urlforge(4, "manual", $mod, "bunny_free"); ?></li>
  </ul>
</div>
