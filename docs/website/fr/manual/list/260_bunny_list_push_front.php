...
<div class="resume">
  <h3>Description</h3>
  $A Add the sent $Sdata@ at first element of $Slist@, making the previous
...
<div class="parameters">
  ...
  <ul>
    ...
    <li>
      $Sdata@:<br />
      $A A data to any type to push at the front of the list.
    </li>
  </ul>
</div>
<hr />
