...
<div class="resume">
  <h3>Description</h3>
  $A Remove the last node of the list and return its data.
</div>
<hr />
...
<div class="return">
  <h3>Return value</h3>
  <p>Return the value that was on back. $CNULL@ if the list was empty.
</div>
<hr />
