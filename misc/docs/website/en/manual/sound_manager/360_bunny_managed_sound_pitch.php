<div class="prototype">
  Macro
  $Tbool@ $Sbunny_managed_sound_pitch@(
...
<div class="resume">
  <h3>Description</h3>
  $A Set the pitch of the sent sound to the given value
  considering the context. The computed value, which
  takes consideration of the proper pitch, the global pitch
  and the category pitch will be stored inside the t_bunny_sound
  itself.
</div>
<hr />
...
<div class="details">
  ...
  <p>
    $Tbool@ $S_bunny_managed_sound_pitch@(
    $Tt_bunny_sound_manager@ *$Ssound_manager@,
    $Tt_bunny_sound@ *$Ssound@,
    $Tdouble@ $Spitch@
    );
...
<div class="related_functions">
  ...
  <ul>
    <li>bunny_managed_sound_volume</li>
  </ul>
</div>
