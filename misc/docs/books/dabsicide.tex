...
La dernière version de Dabsic est actuellement situé dans
la LibLapin. Une bibliothèque que j'ai commencé à développer
en accompagnement d'un projet pédagogique proposé à Epitech où
j'ai enseigné un an et demi. Les allers et venues de la vie
faisant que HBSL a été mis de coté pour favoriser cette bibliothèque.\\
...
\begin{tabular}{|l|c|}
  ...
  Evidemment, l'interprète n'est pas devin: ici, il se contentera de vérifier que la première
